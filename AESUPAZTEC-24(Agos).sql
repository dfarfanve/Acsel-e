...
WHERE
    ...
    AND cntxop.time_stamp >= to_date('16/08/2021','dd-mm-yy') AND cntxop.time_stamp <= to_date('30/08/2021','dd-mm-yy') --agosto
    AND pod.initialdate < to_date('16/08/2021','dd-mm-yy');