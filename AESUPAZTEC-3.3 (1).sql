...
Insert into CLAIMPAYMENT (CLAIMPAYMENTID,CLAIMID,CLAIMPAYMENTDATE,COVERAGEDESCRIPTION,RESERVETYPE,THIRDPARTYID,BENEFICIARY,STATE,AMOUNT,PAIDAMOUNT,DONEBY,RESERVECURRENCYID,PAIDCURRENCYID,EXCHANGERATE,DEDUCTIBLEPERCENTAGE,DEDUCTIBLEREFERENCE,ISDEDUCTIBLEAPPLIED,DEDUCTIBLEAMOUNT,ISPENALTYAPPLIED,PENALTYPERCENTAGE,ISREFUNDAPPLIED,REFUNDPERCENTAGE,ISTOTALPAYMENT,CPY_FRANCHISEAMOUNT) values 
(SQ_CLAIMPAYMENT.nextval,229588,to_date('15/12/22','DD/MM/RR'),'Daños Materiales',0,672907,'BANCO AZTECA SA  DE CV',6,11552,11552,'cgiron',2206,2206,0,null,null,null,null,null,null,null,null,null,null);

UPDATE PAYMENTORDER SET POR_OPERATIONDATE= WHERE PAYMENTORDERID=435703;
