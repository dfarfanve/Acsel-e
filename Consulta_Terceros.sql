...
SELECT NP1.CLIENTEUNICOBAZINPUT,
...
WHERE EXISTS(
              ...
              WHERE NP.CLIENTEUNICOBAZINPUT IS NOT NULL
--AND NP.CLIENTEUNICOBAZINPUT = '24645200153320-10'
                AND NP.CLIENTEUNICOBAZINPUT = NP1.CLIENTEUNICOBAZINPUT
